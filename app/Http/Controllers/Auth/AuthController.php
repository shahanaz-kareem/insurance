...
class AuthController extends Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->loginPath = route('auth.show');
        $this->redirectAfterLogout = route('auth.show');
     ...
     * @return \Illuminate\Http\Response
     */
    protected $loginView = 'global.auth';
...
public function postLogin(Request $request)
{
    ...
    // Build credentials array manually
    ...
    // Increment login attempts if throttling is enabled
    if ($throttles) {
