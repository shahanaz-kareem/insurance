...
class SettingController extends Controller {
    ...
    */
    ...
    public function cache() {
        ...
        return redirect()->route('settings.load');
    }
    ...
    public function get(Request $request)
    {
        ...
        if (in_array($user->role, ['admin', 'super'])) {
            $view_data['company'] = $user->company ?? null;
            $view_data['reminders'] = $user->company && $user->company->reminders
                ? $user->company->reminders->all()
                : [];
        }
    ...
    public function load() {
        return redirect()->route('settings.index')->with('success', trans('settings.message.success.system.edit'))->with('tab', 'system');
    }
}
