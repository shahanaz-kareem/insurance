...
@section('extra_scripts')
    <script type="text/javascript">
        // this Month
        var monthlyPaid = {{ $company->payments()->madeWithin('month')->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
        ...
        var monthlyDue = {{ $company->policies->sum('premium') - $company->payments->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
        ...
        if (monthlyPaid > 0 || monthlyDue > 0) {
            Morris.Donut({
                element: 'monthlySales',
                data: [
                    {label: '{{ trans('dashboard.graph.label.monthly.paid') }}', value: Math.max(0, monthlyPaid)},
                    {label: '{{ trans('dashboard.graph.label.monthly.due') }}', value: Math.max(0, monthlyDue)}
                ],
            ...
            document.getElementById('monthlySales').innerHTML = '<div style="text-align:center;padding:40px;color:#999;">No data available</div>';
        }
        ...
        Morris.Bar({
            element: 'annualSales',
            data: [
                {   x: '{{ trans('dashboard.graph.label.annual.jan') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '01')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.feb') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '02')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.mar') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '03')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.apr') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '04')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.may') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '05')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.jun') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '06')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.jul') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '07')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.aug') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '08')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.sep') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '09')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.oct') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '10')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.nov') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '11')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
                ...
                {   x: '{{ trans('dashboard.graph.label.annual.dec') }}', y: Math.max(0, {{ $company->payments()->madeWithin('month', '12')->get()->sum('amount') - ($company->brokers->reduce(function($count, $broker) {
