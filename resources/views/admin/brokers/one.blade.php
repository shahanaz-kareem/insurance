...
@section('broker_modals')
    ...
    <div class="ui tiny modal" id="editBrokerModal">
        ...
        <div class="scrolling content">
            ...
            <form action="{{ route('brokers.edit', array($broker->id)) }}" enctype="multipart/form-data" method="POST">
                {{ csrf_field() }}
                <div class="ui form">
                    ...
                    <div class="field">
                        ...
                        <input type="file" accept="image/*" data-allowed-file-extensions="bmp gif jpeg jpg png svg" class="file-upload" data-default-file="{{ asset('uploads/images/users/' . $broker->profile_image_filename) }}" name="profile_image"/>
                    </div>
                </div>
            </form>
        </div>
