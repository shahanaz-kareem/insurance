            ...
            <form action="{{ route('staff.edit', array($staff->id)) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="ui form">
                    ...
                    <div class="field">
                        ...
                        <input type="file" accept="image/*" class="file-upload" data-allowed-file-extensions="bmp gif jpeg jpg png svg" data-default-file="{{ asset('uploads/images/users/' . $staff->profile_image_filename) }}" name="profile_image"/>
                    </div>
                </div>
            </form>
        </div>
