        ...
        <div class="ui bottom attached tab segment{{ session()->get('tab', null) === 'reminders' ? ' active' : '' }}" data-tab="reminders">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="{{ route('reminder.update', $company->id) }}" method="POST">
                        {{ csrf_field() }}
                        <div class="ui form">
                            <div class="field">
                                    ...
                                    <p class="transition visible">
                                        <div class="field required">
                                            ...
                                            <select class="ui fluid search dropdown" name="reminders[1][type]">
                                               <option 
                                                    value="email" 
                                                    {{ (old('reminders.1.type', 'email') === 'email') ? 'selected' : '' }}>
                                                    {{ trans('settings.input.option.email') }}
                                                </option>

                                                <option 
                                                    value="text" 
                                                    {{ (old('reminders.1.type') === 'text') ? 'selected' : '' }}>
                                                    {{ trans('settings.input.option.text') }}
                                                </option>
                                        ...
                                        <div class="field required">
                                            ...
                                            <input 
                                                type="text" 
                                                name="reminders[1][subject]" 
                                                placeholder="{{ trans('settings.input.placeholder.subject') }}" 
                                                required 
                                                value="{{ old('reminders.1.subject', '') }}" />
                                        </div>
                                        <div class="two fields">
                                            <div class="field required">
                                                <label>{{ trans('settings.input.label.timeline') }}</label>
                                                <select class="ui fluid search dropdown" name="reminders[1][timeline]">
                                                    <option 
                                                        value="after"
                                                        {{ old('reminders.1.timeline', 'after') === 'after' ? 'selected' : '' }}>
                                                        {{ trans('settings.input.option.after_expiry') }}
                                                    </option>

                                                    <option 
                                                        value="before"
                                                        {{ old('reminders.1.timeline') === 'before' ? 'selected' : '' }}>
                                                        {{ trans('settings.input.option.before_expiry') }}
                                                    </option>
                                                </select>
...
<input 
    ...
    max="365" 
    min="1" 
    name="reminders[1][days]" 
    placeholder="" 
    required 
    step="1" 
    value="{{ old('reminders.1.days', '') }}"
/>
                                            </div>
                                        </div>
                                        <div class="field">
...
<textarea 
    rows="9" 
    name="reminders[1][message]" 
    placeholder="{{ trans('settings.input.placeholder.message') }}" 
    required>{{ old('reminders.1.message', '') }}</textarea>
                                        </div>
                                    </p>
                                </div>
                                @endforelse
                ...
                $('div.accordion').on('click', 'div.title > i.close', function(e) {
                    ...
                    if(element.is('[id]')) {
                        ...
                        $.ajax({
                            ...
                            method: 'DELETE',
                            url: '{{ route('reminder.delete', ['reminder' => 0]) }}'.replace('0', id)
