...
@section('policy_actions')
                    <div class="ui right floated successish button top m-w-140 right pointing dropdown" data-inverted="" data-tooltip="{{ trans('policies.menu.header.tooltip') }}" data-position="left center">
                        ...
                        <div class="menu">
                            ...
                            <div class="item">
                            <form action="{{ route('policies.delete', array($policy->id)) }}" class="item negative" method="POST" style="margin-bottom:0px!important;">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <a href="#" class="delete">
...
@section('policy_modals')
    ...
    <div class="ui tiny modal" id="newPaymentModal">
                ...
                <div class="ui form">
                    <div class="field required">
                        ...
                        <div class="ui selection dropdown">
                            ...
                            <div class="menu">
                                <div class="item{{ old('method') === 'Online Banking' ? ' selected' : null }}" data-value="Online Banking">
                                        <i class="money icon"></i>
                                        Online Banking
                                </div>
                                <div class="item{{ old('method') === 'ECS' ? ' selected' : null }}" data-value="ECS">
                                        <i class="money icon"></i>
                                        ECS
                                </div>
        ...
        <div class="ui tiny modal" id="editPaymentModal">
        <div class="header">Update payment</div>
        <div class="content">
            <p>Update payment of {{$policy->client->first_name}}</p>
            <form id="edit_payment_form" action="{{ route('payments.update') }}"method="POST">
                {{ csrf_field() }}
                ...
                <div class="ui form">
                    <div class="field required">
                        ...
                        <div class="ui selection dropdown">
                            ...
                            <div class="default text">{{ trans('payments.input.placeholder.method') }}</div>
                            <i class="dropdown icon"></i>
                            <div class="menu edit_payment_method_ul">
                                <div id="pay_online" class="pay_list item{{ old('method') === 'Online Banking' ? ' selected' : null }}" data-value="Online Banking">
                                        <i class="money icon"></i>
                                        Online Banking
                                </div>
                                <div id="pay_ecs" class="pay_list item{{ old('method') === 'ECS' ? ' selected' : null }}" data-value="ECS">
                                        <i class="money icon"></i>
                                        ECS
                                </div>
                                <div id="pay_cheque" class="pay_list item{{ old('method') === 'cheque' ? ' selected' : null }}" data-value="cheque">
                                    <i class="money icon"></i>
                                    Cheque
                                </div>
                                <div id="pay_card" class="pay_list item{{ old('method') === 'card' ? ' selected' : null }}" data-value="card">
                                    <i class="credit card alternative icon"></i>
                                    {{ trans('payments.input.option.method.card') }}
                                </div>
                                <div id="pay_cash" class="pay_list item{{ old('method') === 'cash' ? ' selected' : null }}" data-value="cash">
                                    <i class="money icon"></i>
                                    {{ trans('payments.input.option.method.cash') }}
                                </div>
                                <div id="pay_paypal" class="pay_list item{{ old('method') === 'paypal' ? ' selected' : null }}" data-value="paypal">
                                    <i class="paypal card icon"></i>
                                    {{ trans('payments.input.option.method.paypal') }}
                                </div>
                            </div>
        ...
        <div class="actions">
            <div class="ui buttons">
                <button class="ui cancel button">{{ trans('payments.modal.button.cancel.new') }}</button>
                <div class="or" data-text="{{ trans('payments.modal.button.or') }}"></div>
                <button id="edit_payment_button" class="ui positive primary button">{{ trans('payments.modal.button.confirm.update') }}</button>
            </div>
        </div>
    </div>
    <!--print modal-->
                ...
                <div class="ui form">
                    <div class="col-md-6">
                        ...
                        <div class="field required">
                            ...
                            <div class="ui labeled input">
                                ...
                                <input type="text" id="ack_date" class="datepicker" name="ack_date" placeholder="Ack Date" required value="{{ old('ack_date') ?: $ack_date }}"/>
                            </div>
                        </div>
                        <div class="field required">
                            <label>ACK No.</label>
                        ...
                        <div class="field required">
                            ...
                            <?php $policy_date = date("d-m-Y", strtotime($policy->policy_date));?>
                            <div class="ui labeled input">
                                <label for="policy_date" class="ui label"><i class="calendar icon"></i></label>
                                <input type="text" id="policy_date" class="datepicker" name="policy_date" placeholder="policy date" required value="{{ old('policy_date') ?: $policy_date }}"/>
                            </div>
                        </div>
                        <div class="field required">
                        ...
                        <div class="field">
                            ...
                            <?php $expiry = date("d-m-Y", strtotime($policy->expiry));?>
                            <div class="ui labeled input">
                                <label for="expiry" class="ui label"><i class="calendar icon"></i></label>
                                <input type="text" id="expiry" class="datepicker" name="expiry" placeholder="{{ trans('policies.input.placeholder.expiry') }}" value="{{ old('expiry') ?: $expiry }}"/>
                            </div>
                        </div>
                        <div class="field">
                            <label>{{ trans('policies.input.label.renewal') }}</label>
                            <?php $renewal = date("d-m-Y", strtotime($policy->renewal));?>
                            <div class="ui labeled input">
                                <label for="renewal" class="ui label"><i class="calendar icon"></i></label>
                                <input type="text" id="renewal" class="datepicker" name="renewal" placeholder="{{ trans('policies.input.placeholder.renewal') }}" value="{{ old('renewal') ?: $renewal }}"/>
                            </div>
                        </div>
                        <div class="field">
                        ...
                        <div class="field required" data-input-name="premium">
                            ...
                            <input type="text" name="payment_term" id="payment_term" placeholder="Payment Term" required value="{{ old('payment_term') ?: $policy->payment_term }}" onkeyup="calculate();"/>
                        </div>
                        <div class="field required">
                        ...
                        <div class="field">
                            ...
                            <div class="ui labeled input">
                                ...
                                <input type="text" id="premium_chq_date" class="datepicker" name="premium_chq_date" placeholder="Premium Chq. Date" required value="{{ old('premium_chq_date') ?: $premium_chq_date }}"/>
                            </div>
                        </div>
                        <div class="field required" >
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="field required">
                            ...
                            <select class="ui fluid search dropdown" name="branch_manager">
                                    @foreach($branch_manger as $bm)
                                        <option value="{{ $bm->id }}" @if($bm->id == $policy->branch_manager) selected @endif>{{ $bm->staff_code }} -{{ $bm->first_name }} {{ $bm->last_name }}</option>
                                    @endforeach
                        ...
                        <div class="field" >
                            ...
                            <select class="ui fluid search dropdown" name="branch_assist">
                                    ...
                                    @foreach($branch_assist as $ba)
                                        <option value="{{ $ba->id }}" @if($ba->id == $policy->branch_assist) selected @endif>{{ $ba->staff_code }} - {{ $ba->first_name }} {{ $ba->last_name }}</option>
                                    @endforeach
                        ...
                        <div class="field required">
                            ...
                            <input type="text" name="bank_branch" maxlength="64" placeholder="Bank Branch"  value="{{ old('bank_branch') ?: $policy->bank_branch }}"/>
                        </div>
                        ...
                        <div class="field">
                            <label>DOB</label>
                            <?php $ldob = date("d-m-Y", strtotime($policy->ldob));?>
                            <div class="ui labeled input">
                                <label for="ldob" class="ui label"><i class="calendar icon"></i></label>
                                <input type="text" id="ldob" class="datepicker" name="ldob" placeholder="DOB" required value="{{ old('ldob') ?: $ldob }}"/>
                            </div>
                        </div>
                        <div class="field ">
                        ...
                        <div class="field">
                            <label>DOB</label>
                            <?php $ndob = date("d-m-Y", strtotime($policy->ndob));?>
                            <div class="ui labeled input">
                                <label for="ndob" class="ui label"><i class="calendar icon"></i></label>
                                <input type="text" id="ndob" class="datepicker" name="ndob" placeholder="DOB"  value="{{ old('ndob') ?: $ndob }}"/>
                            </div>
                        </div>
                        <div class="field ">
                            <label>Mobile Number</label>
                    ...
                    <div class="field">
                        <label>{{ $custom_field->label }}</label>
                        <textarea name="custom_fields[C{{ $policy->client->company->id }}F{{ $custom_field->id }}][value]"{{ isset($custom_field->required) ? ' required' : '' }} rows="2">{{ $custom_field->value }}</textarea>
                    </div>
                        @else
...
@section('extra_scripts')
        ...
        function calculate(){
            ...
            if(payment_term ==''){
                ...
                if(mode_payment=='annually'){
                    ...
                    var p_amount        = parseInt(payment_term) * 4;
                    var policy_amount   = parseInt(p_amount) * parseInt(amount) ;
                    $('.policy_amount').val(policy_amount);
                }
                else if(mode_payment=='half yearly'){
                    var p_amount        = parseInt(payment_term) * 2;
                    var policy_amount   = parseInt(p_amount) * parseInt(amount) ;
                    $('.policy_amount').val(policy_amount);
                } else {
                    $('.policy_amount').val('');
    ...
    $( ".editPaymentModalBtn" ).click(function() {
     //   console.log("Onclick");
     var payment_id = $(this).data('id');
     var payment_date = $(this).data('date'); 
     var payment_method = $(this).data('method'); 
     console.log("Payment Date : "+payment_date);
     console.log("Payment Method : "+payment_method);
     $("#editPaymentModal #payment_id_edit").val( payment_id );
     $("#editPaymentModal #amount").val( $(this).data('amount') );
     $("#editPaymentModal #paymentDate").val(payment_date);
    $("#editPaymentModal .pay_list").removeClass("active selected");
    $("#editPaymentModal .edit_payment_method_ul").removeClass("hidden");
    $("#editPaymentModal .edit_payment_method_ul").addClass("visible");
     if(payment_method=='cash'){
         $("#editPaymentModal #pay_cash").addClass("active selected");
         $("#editPaymentModal .edit_payment_method_ul").removeClass("visible");
         $("#editPaymentModal .edit_payment_method_ul").addClass("hidden");
         
     }else if(payment_method=='card'){
        $("#editPaymentModal #pay_card").addClass("active selected");
        $("#editPaymentModal .edit_payment_method_ul").removeClass("visible");
        $("#editPaymentModal .edit_payment_method_ul").addClass("hidden");
     }else if(payment_method=='paypal'){
         $("#editPaymentModal #pay_paypal").addClass("active selected");
                  $("#editPaymentModal .edit_payment_method_ul").removeClass("visible");
         $("#editPaymentModal .edit_payment_method_ul").addClass("hidden");
     }else if(payment_method=='cheque'){
         $("#editPaymentModal #pay_cheque").addClass("active selected");
                  $("#editPaymentModal .edit_payment_method_ul").removeClass("visible");
         $("#editPaymentModal .edit_payment_method_ul").addClass("hidden");
     }else if(payment_method=='ecs' || payment_method=='ECS'){
         $("#editPaymentModal #pay_ecs").addClass("active selected");
                  $("#editPaymentModal .edit_payment_method_ul").removeClass("visible");
         $("#editPaymentModal .edit_payment_method_ul").addClass("hidden");
     }else{
         $("#editPaymentModal .pay_list").removeClass("active selected");
