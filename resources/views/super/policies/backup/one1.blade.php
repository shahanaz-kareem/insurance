                    ...
                    <div class="col-md-6">
                        ...
                        <div class="field required" data-input-name="premium">
                            ...
                            <div class="ui labeled input">
                                ...
                                <input type="number" id="premium" min="0" name="premium" placeholder="Policy Amount" required value="{{ old('premium') ?: $policy->premium }}"/>
                            </div>
                        </div>
                        ...
                        <div class="field required" data-input-name="premium">
                            ...
                            <div class="ui labeled input">
                                <label for="premium" class="ui label">{{ $policy->currency_symbol }}</label>
                                <input type="number" id="premium_amount" min="0" name="premium_amount" placeholder="Premium Amount" required value="{{ old('premium_amount') ?: $policy->premium_amount }}"/>
                            </div>
                        </div>

                        <div class="field required" data-input-name="premium">
                            <label>Payment Term</label>
                            <input type="text" name="payment_term" placeholder="Payment Term" value="{{ old('payment_term') ?: $policy->payment_term }}"/>
                        </div>
                        <div class="field required">
