            ...
            <table class="ui striped table">
                ...
                <tbody>
                    ...
                    <tr class="{{ $policy->statusClass }}">
                        ...
                        <td class="center aligned"><a href="{{ route('policies.one', $policy->id) }}" class="ui mini grey label"> {{ trans('dashboard.table.data.action') }} </a></td>
                    </tr>
                    @empty
                    <tr>
    ...
    <script type="text/javascript">
        ...
        Morris.Donut({
            ...
            data: [
               ...
               {label: 'commission', value: @json($commission ?? 0)}
