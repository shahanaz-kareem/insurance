            ...
            <form action="{{ route('products.add') }}" method="POST">
                ...
                <div class="ui form">
                    ...
                    <div class="field required" >
                        ...
                        <select class="ui fluid search dropdown" name="insurer">
                            @foreach($companies1 as $company)
                            <option{{ !empty(old('company_id')) && old('company_id') === $company->id || empty(old('company_id')) && $company === $user->company ? ' selected' : '' }} value="{{ $company->name }}">{{ $company->name }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="ui form">
                    ...
                    <div class="field required">
                        ...
                        <select class="ui fluid search dropdown" name="insurer" required>
                            @foreach($companies1 as $company)
                            <option{{ $company->name === $product->insurer ? ' selected' : '' }} value="{{ $company->name }}">{{ $company->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="field required" style="display: none">
