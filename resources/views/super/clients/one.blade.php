...
@section('client_modals')
    ...
    <div class="ui tiny modal" id="editClientModal">
        ...
        <div class="scrolling content">
            ...
            <form action="{{ route('clients.edit', array($client->id)) }}" enctype="multipart/form-data" method="POST">
                {{ csrf_field() }}
                <div class="ui form">
                    ...
                    <div class="two fields">
                        <?php $birthday = date("d-m-Y", strtotime($client->birthday));?>
                        <div class="field">
                            <label>{{ trans('clients.input.label.birthday') }}</label>
                            <input type="text" class="datepicker" name="birthday" placeholder="{{ trans('clients.input.placeholder.birthday') }}" value="{{ old('birthday') ?: $birthday }}"/>
                        </div>
                        ...
                        <div class="field required">
                            ...
                            @if($branch->id == $client->branch_id)
                                <option value="{{ $branch->id }}" @if($branch->id == $client->branch_id) selected @endif>{{ $branch->branch_name }}</option>
                            @endif
                            @endforeach
                            </select>
                        </div>
                    ...
                    <div class="field">
                        ...
                        <textarea name="address" rows="3" placeholder="{{ trans('clients.input.placeholder.address') }}">{{ old('address') ?: $client->address }}</textarea>
                    </div>
                    ...
                    <!-- <div class="field required">
                        ...
                        <div class="ui selection dropdown">
                            ...
                            <div class="menu" id="">
                                ...
                                <div class="company{{ $company->id }} item{{ !empty(old('inviter_id')) && old('inviter_id') === $company->id || empty(old('company_id')) && $company->id === $client->inviter->id ? ' selected' : '' }}" data-value="{{ $company->id }}"{!! $company->id === $client->company->id ? '' : ' style="display:none;"'  !!}>
                                    <i class="building icon"></i>
                                    {{ $company->name }} {{ $company->id === $user->id ? trans('clients.input.option.you') : '' }}
                                </div>
