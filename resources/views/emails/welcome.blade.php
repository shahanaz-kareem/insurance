            ...
            <tbody>
              ...
              <tr>
                <td style="padding:10px 0 30px 0;">
                  ...
                  <center>
                    <a href="{{ route('password.activate.get', ['token' => $token]) }}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #00c0c8; border-radius: 60px; text-decoration:none;">{{ trans('emails.button.welcome') }}</a>
                  </center>
