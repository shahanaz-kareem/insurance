                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center aligned">
                            <a href="{{ route('emails.all', array($contact->id)) }}" class="ui large blue label"> {{ trans('communication.table.data.action.emails') }} </a>
                        </td>
                        <td class="center aligned">
                            <a href="{{ route('texts.all', array($contact->id)) }}" class="ui large green label"> {{ trans('communication.table.data.action.texts') }} </a>
                        </td>
                    </tr>
                    @empty
                    <tr>
