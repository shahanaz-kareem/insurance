            ...
            <div class="user-profile m-b-15">
                <div class="circular ui icon button top right pointing dropdown edit-profile-btn" data-inverted="" data-tooltip="{{ trans('brokers.menu.header.tooltip') }}" data-position="left center">
                    ...
                    <div class="menu">
                        ...
                        <div class="item">
                            <a href="{{ route('inbox.all', ['chatee' => $broker->id]) }}"><i class="comments icon"></i> {{ trans('brokers.menu.item.chat') }}</a>
                        </div>
                        <form action="{{ route('brokers.delete', array($broker->id)) }}" class="item negative" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                ...
                @else
                <img src="{{ 'http://iworksync.com/ebs/insurance/storage/app/images/users/' . $broker->profile_image_filename }}" alt="{{ $broker->first_name . ' ' . $broker->last_name }}">
                @endif
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="ui aligned center">
                                <a class="ui grey mini label" href="{{ route('clients.one', array($client->id)) }}"> {{ trans('brokers.table.data.action.view') }} </a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                ...
                <table class="ui table">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $policy->statusClass }}">
                            ...
                            <td class="center aligned">
                                <a class="ui mini grey label" href="{{ route('policies.one', array($policy->id)) }}"> {{ trans('brokers.table.data.action.view') }} </a>
                            </td>
                        </tr>
                        @empty
                        <tr>
