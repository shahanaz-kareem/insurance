            ...
            <div class="user-profile m-b-15">
                <div class="circular ui icon button top right pointing dropdown edit-profile-btn" data-inverted="" data-tooltip="{{ trans('clients.menu.header.tooltip') }}" data-position="left center">
                    ...
                    <div class="menu">
                        ...
                        <!-- <div class="item">
                            <a href="{{ route('inbox.all', ['chatee' => $client->id]) }}"><i class="comments icon"></i> {{ trans('clients.menu.item.chat') }}</a>
                        </div> -->
                ...
                <div class="text-avatar" style="background-color:{{ collect(config('insura.colors'))->random() }};">{{ strtoupper((isset($client->first_name) && strlen($client->first_name) > 0 ? $client->first_name[0] : '') . (isset($client->last_name) && strlen($client->last_name) > 0 ? $client->last_name[0] : '')) }}</div>
                @else
                ...
                <table class="ui table">
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td>
                                {{ $funds->mproduct ? $funds->mproduct->product_name : 'N/A' }}
                            </td>
                            <td>{{ $funds->amount }}</td>
                ...
                <div class="ui form">
                    ...
                    <div class="two fields">
                        <div class="field required">
                            ...
                            <div class="ui labeled input">
                                ...
                                <input type="number" id="premium" min="0" name="premium[{{ $client->id }}]" placeholder="{{ trans('policies.input.placeholder.premium') }}" required value="{{ isset(old('premium')[$client->id]) ? old('premium')[$client->id] : '' }}"/>
                            </div>
                        </div>
                        <div class="field">
                    ...
                    <div class="three fields">
                        <div class="field">
                            ...
                            <div class="ui labeled input">
                                <label for="amount" class="ui label">{{ $client->currency_symbol }}</label>
                                <input type="number" id="amount" min="0" name="amount[{{ $client->id }}]" placeholder="{{ trans('policies.input.placeholder.amount') }}" value="{{ isset(old('amount')[$client->id]) ? old('amount')[$client->id] : '' }}"/>
                            </div>
                        </div>
                        <div class="field">
                            <label>{{ trans('policies.input.label.payment_date') }}</label>
                            <input type="text" class="datepicker" name="date[{{ $client->id }}]" placeholder="{{ trans('policies.input.placeholder.payment_date') }}" value="{{ isset(old('date')[$client->id]) ? old('date')[$client->id] : '' }}"/>
                        </div>
                        <div class="field">
                            <label>{{ trans('policies.input.label.payment_method') }}</label>
                            <div class="ui selection dropdown">
                                <input type="hidden" name="method[{{ $client->id }}]" value="{{ isset(old('method')[$client->id]) ? old('method')[$client->id] : '' }}"/>
                ...
                <div class="ui form">
                    <div class="col-md-6">
                        ...
                        <div class="field required">
                            <label>ACK Date</label>
                            <div class="ui labeled input">
                                <label for="ack_date" class="ui label"><i style="display:none;" class="calendar icon"></i></label>
                                <input type="date" id="ack_date" class="datepicker" name="ack_date" placeholder="Ack Date" required value="{{ old('ack_date') }}"/>
                            </div>
                        </div>
                        <div class="field required">
                            <label>ACK No.</label>
                        ...
                        <div class="field required">
                            ...
                            <input type="text" name="point_login" id="point_login" placeholder="Point of Login" value="{{ old('point_login') }}" required/>
                        </div>
                        <div class="field required">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="sum_assured" id="sum_assured" placeholder="Sum Assured Amount" value="{{ old('sum_assured') }}" />
                        </div>
                        <div class="field required" data-input-name="premium">
                            <label>Policy Amount</label>
                            <div class="ui labeled input">
                                <label for="premium" class="ui label">{{ $currency_symbol }}</label>
                                <input type="number" id="premium" min="0" name="premium[{{ $client->id }}]" placeholder="Policy Amount" class="policy_amount" required value="{{ old('premium.' . $client->id) }}" readonly />
                            </div>
                        </div>
                        <div class="field required">
                            <label>Premium Amount</label>
                            <div class="ui labeled input">
                                <label for="amount" class="ui label">{{ $currency_symbol }}</label>
                                <input type="number" id="amount" name="amount[{{ $client->id }}]" min="0" placeholder="{{trans('payments.input.placeholder.amount')}}" class="p_due" required value="{{ old('amount.' . $client->id) }}" onkeyup="calculate();"/>
                            </div>
                            <input type="hidden" name="premium_amount" id="premium_amount" value="">
                        </div>
                        <div class="field required">
                            <label>Payment Term(In Years)</label>
                            <input type="text" name="payment_term" id="payment_term" placeholder="Payment Term" value="{{ old('payment_term') }}" onkeyup="calculate();" required/>
                        </div>
                        <div class="field required">
                            <label>Mode Payment</label>
                            <select class="ui fluid dropdown selection" name="type"  required value="{{ old('type') }}" onChange="calculate();" id="mode_payment" required>
                        ...
                        <div class="field required" data-input-name="premium">
                            ...
                            <div class="ui labeled input">
                                <label for="premium_chq_amount" class="ui label">{{ $currency_symbol }}</label>
                    ...
                    <div class="client client{{ $client->id }}" style="display:none;">
                        <div class="field required">
                            ...
                            <input type="text" class="datepicker" name="date[{{ $client->id }}]" placeholder="Login Date" value="{{ old('date.' . $client->id) }}" />
                        </div>
                        <div class="field required">
                            <label>{{ trans('policies.input.label.payment_method') }}</label>
                            <div class="ui selection dropdown required">
                                <input type="hidden" name="method[{{ $client->id }}]" value="{{ old('method.' . $client->id) }}" required/>
                                <div class="default text">{{ trans('policies.input.placeholder.payment_method') }}</div>
                                <i class="dropdown icon"></i>
                                <div class="menu">
                                    <div class="item{{ old('method.' . $client->id) === 'Online Banking' ? ' selected' : null }}" data-value="Online Banking">
                                        <i class="money icon"></i>
                                        Online Banking
                                    </div>
                                    <div class="item{{ old('method.' . $client->id) === 'ECS' ? ' selected' : null }}" data-value="ECS">
                                        <i class="money icon"></i>
                                        ECS
                                    </div>
                    ...
                    <div class="two fields">
                        <div class="disabled field required">
                            <label>{{ trans('policies.input.label.payment_date') }}</label>
                            <input type="text" class="datepicker" disabled placeholder="{{ trans('policies.input.placeholder.payment_date') }}" required/>
                        </div>
                        <div class="disabled field required">
                            <label>{{ trans('policies.input.label.payment_method') }}</label>
