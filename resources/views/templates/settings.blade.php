            ...
            <div class="row">
                <div class="col-md-6">
                    <p>{{ trans('settings.tab.message.profile') }}</p>
                                        <form action="{{ route('user.edit', ['user' => $user->id]) }}" enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }}
                        <div class="ui form">
                            ...
                            <div class="field">
                                ...
                                <input type="file"  accept="image/*" class="file-upload" data-allowed-file-extensions="bmp gif jpeg jpg png svg" data-default-file="{{ 'http://integrityindia.co.in/insurance/storage/app/images/users/' . $user->profile_image_filename }}" name="profile_image">
                            </div>
                            <div class="field">
