...
<head>
    ...
    <meta content="Insurance - Policy Manager" name="description">
    ...
    <link href="{{ asset('uploads/images/' . config('insura.favicon')) }}" rel="icon" type="">
    <!-- Font and Icon Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Alegreya+Sans:300,400,500,700" rel="stylesheet">
    <link href="{{ asset('assets1/fonts/ionicons/css/ionicons.min.css') }}" rel="stylesheet">
    <!-- Core CSS -->
    <link href="{{ asset('assets1/libs/bootstrap/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets1/libs/semantic-UI/semantic.min.css') }}" rel="stylesheet">
    <!-- Page Specific CSS -->
    <link href="{{ asset('assets1/libs/scrollbars/jquery.scrollbar.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ asset('assets1/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('assets1/css/chat.css') }}" rel="stylesheet">
...
<body>
            ...
            <div class="ui fluid selection search dropdown">
                ...
                <div class="menu">
                    ...
                    <div class="item" data-value="{{ $contact->id }}">
                        <img class="ui mini avatar image" src="{{ 'http://integrityindia.co.in/insurance/storage/app/images/users/' . $contact->profile_image_filename }}">
                        {{ $contact->fullName }}
                    </div>
                    @empty
        ...
        <div class="people-list">
            <ul class="people">
                ...
                <li class="person" data-person="{{ $contact->id }}"{!! in_array($contact->id, $chatees->all()) ? '' : ' style="display:none;"' !!}>
                    <img src="{{ 'http://integrityindia.co.in/insurance/storage/app/images/users/' . $contact->profile_image_filename }}" alt="{{ $contact->first_name }}'s Profile Photo" />
                    <span class="name">
                        {{ $contact->fullName }}
    ...
    <div class="inbox-right">
        ...
        @endforeach
        <form action="{{ route('chats.send') }}" class="write">
    ...
    <script src="{{ asset('assets1/libs/semantic-UI/semantic.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets1/js/insura.js') }}" type="text/javascript"></script>
    <!-- Page Specific Scripts -->
    <script src="{{ asset('assets1/libs/scrollbars/jquery.scrollbar.min.js') }}" type="text/javascript"></script>
    ...
    <!-- Custom Scripts -->
    <script src="{{ asset('assets1/js/app.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets1/js/inbox.js') }}" type="text/javascript"></script>
</body>
</html>
