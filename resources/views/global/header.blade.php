<header>
               ...
               {{-- <div class="ui very relaxed horizontal list">
                    <div class="item">
                        <div class="bottom aligned content">
                            <a class="header insura-chats" data-inverted="" data-position="bottom center" data-tooltip="{{ trans('header.tooltip.message') }}" href="{{ route('inbox.all') }}">
            ...
            <div class="ui left floated segment header-avatar">
                <div class="ui very relaxed horizontal list">
                    <div class="ui item top-avatar top right pointing icon dropdown">
                        <img class="ui avatar image" src="{{ 'http://integrityindia.co.in/insurance/storage/app/images/users/' . $user->profile_image_filename }}">
                        ...
                        <div class="menu">
                            ...
                            <div class="item">
                                <a href="{{ route('settings.index') . '#profile' }}"><i class="ion-person icon"></i> {{ trans('header.link.profile') }}</a>
                            </div>
                            <div class="item">
                                <a href="{{ route('settings.index') }}"><i class="ion-gear-a icon"></i> {{ trans('header.link.settings') }}</a>
                            </div>
                            <div class="item active selected">
                                    <a href="{{ route('logout') }}"><i class="ion-log-out icon"></i> {{ trans('header.link.log_out') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="small-monitor">
            ...
            <div class="branding-icon">
                <a href="{{ route('dashboard') }}">
                    <img src="{{ 'http://integrityindia.co.in/insurance/storage/app/images/' . config('insura.favicon') }}" class="ui image">
                </a>
            </div>
        </div>
    </header>
