            ...
            <div class="ui segment white fs-16">
                ...
                <div class="sms-list">
                    ...
                    <div class="sms-item text-{{ $text->status ? 'success' : 'danger' }}">
                        ...
                        <form action="{{ route('texts.delete', array($text->id)) }}" class="delete-sms" data-tooltip="{{ trans('communication.table.data.action.delete') }}" data-position="left center" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
